...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name'=>'administradors.index',
                            'description'=>'ver listado de administradores'])->syncRoles([$role1, $role2]);
        ...
        Permission::create(['name'=>'nutricionistas.edit',
                            'description'=>'editar nutricionista'])->syncRoles([$role1]);
        ...
        Permission::create(['name'=>'suscripcion_usuarios.create',
                            'description'=>'crear suscripcion'])->syncRoles([$role1, $role3]);
        ...
        Permission::create(['name'=>'tipo_medidas.create',
                            'description'=>'crear tipo de medida'])->syncRoles([$role1]);
        Permission::create(['name'=>'tipo_medidas.edit',
                            'description'=>'editar tipo de medida'])->syncRoles([$role1]);
        Permission::create(['name'=>'tipo_medidas.destroy',
                            'description'=>'eliminar tipo de medida'])->syncRoles([$role1]);
        ...
        Permission::create(['name'=>'tratamientos.create',
                            'description'=>'crear tratamiento'])->syncRoles([$role1]);
        Permission::create(['name'=>'tratamientos.edit',
                            'description'=>'editar tratamiento'])->syncRoles([$role1]);
        Permission::create(['name'=>'tratamientos.destroy',
                            'description'=>'eliminar tratamiento'])->syncRoles([$role1]);
        ...
        Permission::create(['name'=>'users.create',
                            'description'=>'crear usuarios'])->syncRoles([$role1, $role3]);
        ...
        Permission::create(['name'=>'actividads.create',
                            'description'=>'crear actividad'])->syncRoles([$role1]);
        Permission::create(['name'=>'actividads.edit',
                            'description'=>'editar actividad'])->syncRoles([$role1]);
        Permission::create(['name'=>'actividads.destroy',
                            'description'=>'eliminar actividad'])->syncRoles([$role1]);
        ...
        Permission::create(['name'=>'alimentos.create',
                            'description'=>'crear alimento'])->syncRoles([$role1]);
        Permission::create(['name'=>'alimentos.edit',
                            'description'=>'editar alimento'])->syncRoles([$role1]);
        Permission::create(['name'=>'alimentos.destroy',
                            'description'=>'eliminar alimento'])->syncRoles([$role1]);

        // Permission::create(['name'=>'recetas.index',
        //                     'description'=>'ver listado de usuarios'])->syncRoles([$role1]);
        Permission::create(['name'=>'recetas.create',
                            'description'=>'crear receta'])->syncRoles([$role1]);
        Permission::create(['name'=>'recetas.edit',
                            'description'=>'editar receta'])->syncRoles([$role1]);
        Permission::create(['name'=>'recetas.destroy',
                            'description'=>'eliminar receta'])->syncRoles([$role1]);
